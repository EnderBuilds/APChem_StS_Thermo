    ...
    \begin{enumerate}
        \item Which plot represents an exothermic reaction? %[ZumdahlThermoDynamics.pdf Page 1, Question 2]
            ...
            \begin{enumerate}
                ...
                \item Potential energy diagrams do not indicate if a reaction is exothermic
            \end{enumerate}
        ...
        \item Predict the sign of $\Delta S^\circ$ for the following reaction:
            ...
            \begin{enumerate}
                ...
                \item Positive at high temperatures, negative at low temperatures
            \end{enumerate}
        ...
        \item Which substance has the greater value of $S^\circ$? %[ZumdahlThermoDynamics.pdf Page 12, Question 35b]
            \begin{enumerate}
                ...
                \item Both are equal
                \item $\ce{C2H5OH(s)}$
                \item Cannot be determined without temperature
            \end{enumerate}
        ...
        \item In reaction 1, seven particles in solution form one particle. In reaction 2, four particles form one. Which reaction has a more favorable $\Delta S$? %[ZumdahlThermoDynamics.pdf Page 14, Question 81]
            \begin{enumerate}
                ...
                \item Entropy is not affected by particle count
            \end{enumerate}
...
\begin{enumerate}
    ...
    \item \textbf{E} ($0$). By definition of equilibrium. \textit{[New Jersey Center for Teaching and Learning, Page 15, Question 57]}
